    ...
    <section className="gallery" id="gallery">
      ...
      <div className="carousel-container">
        ...
        <div className="gallery-socials">
          <h3>Follow Us</h3>
          <p className="socials-subtitle">Please follow us on social media to see the latest posts</p>
          <div className="socials">
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" title="Meta (Facebook)">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
